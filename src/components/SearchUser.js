...
const SearchUser = () => {
  ...
  const addFriend = async () => {
    ...
    const friendCollectionRef3 = collection(
      db,
      "messaging",
      msgId,
      "with"
  ...
  return (
    <>
      ...
      >
        {friend && <button type="button" className="btn btn-warning mx-1" disabled>
          Add Friend
        </button>}
        {!friend && <button type="button" className="btn btn-warning mx-1" onClick={addFriend}>
          Add Friend
        </button>}
        {friend && <button
          type="button"
        ...
        {!friend && <button
          type="button"
          className="btn btn-warning mx-1" disabled 
        >
          Message
        </button>}
